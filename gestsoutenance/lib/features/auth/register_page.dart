    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (success && mounted) {
            ...
            SnackBar(
              content: const Row(
                children: [
                  ...
                  SizedBox(width: 12),
                  Expanded(
                    child: Text('Inscription réussie ! Bienvenue !'),
                  ),
                ],
              ),
          ...
          final errorMessage = authProvider.lastError ?? 'Erreur lors de l\'inscription. Veuillez réessayer.';
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Row(
                children: [
              ...
              child: Column(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Rejoignez-nous pour gérer vos soutenances',
                      style: TextStyle(
                        fontSize: 16,
